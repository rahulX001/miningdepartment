...
const features = [
    { name: 'Drill ID', description: 'DR-001' },
    { name: 'Location', description: 'Mine Section A' },
    ...
    return (
      <div className="bg-white">
        <div className="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4 py-24 sm:px-6 sm:py-20 lg:max-w-7xl lg:grid-cols-2 lg:px-8">
          <div>
            <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Drill Management Dashboard</h2>
            <p className="mt-4 text-gray-500">
            Real-time Insights for Optimal Drill Performance
            </p>
